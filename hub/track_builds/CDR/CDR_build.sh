...
bedToBigBed \
    -type=bed9 \
    -as=hg002v1.1_ont_hmmCDR_subCDR.as \
...
bedToBigBed \
    -type=bed3 \
    -as=hg002v1.1_ont_hmmCDR_priors.as \
...
bedToBigBed \
    -type=bed9 \
    -as=hg002v1.1_hifi_hmmCDR_subCDR.as \
...
bedToBigBed \
    -type=bed3 \
    -as=hg002v1.1_hifi_hmmCDR_priors.as \
